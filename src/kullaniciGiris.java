...
public class kullaniciGiris extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/1466603145_login.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!kullaniciAdi.equals("") && !sifre.equals("")) {
            try {
                ...
                ResultSet rs = db.baglan().executeQuery("Select * from kullanicilar where kullanici_adi='" + kullaniciAdi + "' and sifre='" + sifre + "'");
                if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(this, "Lütfen Bütün Alanları Doldurunuz...");
